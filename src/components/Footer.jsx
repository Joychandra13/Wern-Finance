...
function Footer() {
  ...
  return (
    <>
        <footer className="bg-[#292834]/25 mt-[128px] mb-[569px] pb-[135px]">
            <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-6 gap-y-5 gap-x-2.5 lg:gap-8 pt-[60px] w-full max-w-[1440px] px-2.5 md:px-10 lg:px-20 xl:px-24  mx-auto">
